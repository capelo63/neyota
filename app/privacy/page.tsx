...
export const metadata: Metadata = {
  ...
  description: 'Politique de confidentialité et protection des données personnelles sur Terii',
};
          ...
          <div className="prose prose-neutral max-w-none">
            ...
            <section className="mb-8">
              <p className="text-neutral-700 leading-relaxed mb-4">
                La protection de vos données personnelles est une priorité pour Terii. Cette
            ...
            <section className="mb-8">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Le responsable du traitement des données personnelles est Terii, accessible via
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-neutral-700 space-y-2">
                ...
                <li><strong>L&apos;exécution du contrat</strong> : fourniture des services Terii</li>
