...
import { BLOG_CATEGORIES, BlogCategory, BlogPost } from '@/lib/constants/blog';
...
export default function EditBlogPostPage({ params }: Props) {
  ...
  useEffect(() => {
    async function init() {
      ...
      setCategory(p.category as BlogCategory);
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-neutral-900">Modifier l&apos;article</h1>
        </div>
          ...
          <div>
            ...
            {(coverPreview ?? existingCoverUrl) && (
              <img
                ...
                className="mb-3 max-h-48 rounded-lg object-cover border border-neutral-200"
              />
            )}
            <input
              type="file"
