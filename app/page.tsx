          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-neutral-600 mb-8 max-w-2xl mx-auto leading-relaxed animate-slide-up">
                Terii connecte gratuitement les porteurs de projets et les talents locaux
            ...
            {projects.length === 0 ? (
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-neutral-600 mb-6">
                  Soyez parmi les premiers à rejoindre Terii et faites vivre votre territoire.
                </p>
                <Link href="/signup">
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-10 text-primary-100">
                Rejoignez la communauté Terii et donnez vie à vos projets locaux
              </p>
          ...
          <div className="container-custom">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="md:col-span-2">
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-2xl font-bold text-white">Terii</span>
                    </div>
              ...
              <div className="pt-8 border-t border-neutral-800 text-center text-sm text-neutral-400">
                <p>© 2026 Terii. Tous droits réservés.</p>
              </div>
            </div>
          </div>
        </footer>
