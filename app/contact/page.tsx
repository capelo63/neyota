...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Contactez l\'équipe Teriis pour toute question ou suggestion',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-neutral-600">
                  Nous prenons la protection de vos données très au sérieux. Teriis est conforme
              ...
              <div>
                ...
                <p className="text-neutral-600">
                  Oui ! Bien que Teriis privilégie les collaborations territoriales, de nombreux
          ...
          <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl shadow-sm p-8 text-white text-center">
            <h2 className="text-2xl font-semibold mb-4">
              Rejoignez la communauté Teriis
            </h2>
